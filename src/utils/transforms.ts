...
export function shopifyProductToProductListItem(shopifyProduct: Shopify_Product): ProductListItem {
  ...
  return {
    ...
    reviewsAverage: shopifyProduct.reviews?.stats?.average,
    reviewsCount: shopifyProduct.reviews?.stats?.count,
...
export function shopifyProductToProduct(shopifyProduct: Shopify_Product): Product {
  ...
  return {
    ...
    reviews: shopifyProduct.reviews.reviews && getReviews(shopifyProduct.reviews.reviews),
    reviewsAverage: shopifyProduct.reviews?.stats?.average,
    reviewsCount: shopifyProduct.reviews?.stats?.count,
