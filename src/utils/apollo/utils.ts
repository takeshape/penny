...
export function relayStylePagination<TNode = Reference>(keyArgs: KeyArgs = false): RelayFieldPolicy<TNode> {
  return {
    keyArgs,

    read(existing, { canRead, readField }) {
      console.log('relayStylePagination', 'read', existing);
    ...
    merge(existing, incoming, { args, isReference, readField }) {
      console.log('relayStylePagination', 'merge', existing, incoming);
      if (!existing) {
