    ...
    <div className={`${className} relative`}>
      ...
      <input
        ...
        className={classNames(
          ...
          'mt-1 block w-full shadow-sm bg-formBackground border-formText-900 placeholder-formText-300 text-formText-900 sm:text-sm rounded-md disabled:bg-formText-100 disabled:cursor-not-allowed'
        )}
      />
      {error && (
