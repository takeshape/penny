  ...
  return (
    <div className="w-full grid grid-cols-1 gap-y-8 gap-x-6 items-start sm:grid-cols-12 lg:gap-x-8">
      ...
      <div className="sm:col-span-8 lg:col-span-7">
        <h2 className="text-2xl font-extrabold text-mainText-900 sm:pr-12">{product.name}</h2>
        ...
        <section aria-labelledby="options-heading" className="mt-10">
          ...
          <form>
            {/* Colors */}
            <div>
              <h4 className="text-sm text-mainText-900 font-medium">Color</h4>
            ...
            <div className="mt-10">
              <div className="flex items-center justify-between">
                <h4 className="text-sm text-mainText-900 font-medium">Size</h4>
            ...
            <button
              ...
              disabled={!hasStock}
              type="submit"
              className="mt-6 w-full bg-accent-600 border border-transparent rounded-md py-3 px-8 flex items-center justify-center text-base font-medium text-invertedText hover:bg-accent-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-accent-500 disabled:bg-gray-300 disabled:cursor-not-allowed"
            >
              Add to cart
            </button>
