...
export const NavigationTop = ({ onOpenMobileMenu, links, currencies }: NavigationTopProps) => {
  return (
    <nav aria-label="Top">
      {/* Top navigation */}
...
export default function ConnectedNavigationTop() {
  const { openMobileMenu, links } = useNavigation();
  return <NavigationTop onOpenMobileMenu={openMobileMenu} links={links} currencies={[...currencyList]} />;
}
