      ...
      return (
        <>
          <button
            ...
            className="w-full flex items-center justify-center  py-2 px-2.5 border border-transparent rounded-md shadow-sm text-sm font-medium bg-body-200 text-body-900 hover:bg-body-300 hover:text-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-accent-500 sm:w-full sm:flex-grow-0"
          >
            Report an issue
          </button>
