export const OrderSkeleton = () => (
  <div className="animate-pulse shadow sm:rounded-md sm:overflow-hidden p-2 sm:p-4 w-full">
    <header className="mb-4 bg-body-50 rounded-lg p-2 sm:p-4 sm:flex sm:items-center sm:justify-between sm:space-x-6 lg:space-x-8">
      <dl className="divide-y divide-body-200 space-y-6 text-sm text-body-600 flex-auto sm:divide-y-0 sm:space-y-0 sm:grid sm:grid-cols-3 sm:gap-x-6 lg:gap-x-8">
        <div className="flex justify-between pt-6 font-medium text-body-900 sm:block sm:pt-0">
          <dt>
            <div className="w-24 bg-body-300 h-4 rounded-md" />
          </dt>
          <dd className="sm:mt-1">
            <div className="w-32 bg-body-300 h-4 rounded-md" />
          </dd>
        </div>
        <div className="flex justify-between sm:block">
          <dt className="font-medium text-body-900">
            <div className="w-24 bg-body-300 h-4 rounded-md" />
          </dt>
          <dd className="sm:mt-1">
            <div className="w-32 bg-body-300 h-4 rounded-md" />
    ...
    <main className="my-2 px-2">
      <div>
        <header className="w-full mb-2 pb-2 border-b border-body-5300 text-sm text-body-500">
          <div className="w-32 bg-body-300 h-4 rounded-md" />
        </header>
        <div className="w-24 bg-body-300 h-4 rounded-md" />
      </div>
        ...
        <tbody className="border-b border-body-200 divide-y divide-body-200 text-sm sm:border-t">
          <tr>
            <td className="flex py-6 pr-8">
              <div className="flex bg-body-300 rounded-md items-center w-16 h-16 mr-6" />
              <div className="flex flex-col gap-2">
                <div className="w-24 bg-body-300 h-4 rounded-md" />
                <div className="w-16 bg-body-300 h-4 rounded-md" />
              </div>
            </td>
            <td className="py-6 pr-8">
              <div className="w-6 bg-body-300 h-4 rounded-md" />
            </td>
