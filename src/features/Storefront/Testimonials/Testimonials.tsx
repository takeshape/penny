  ...
  return (
    ...
    >
      <div className="max-w-2xl mx-auto lg:max-w-none">
        <h2 id="testimonial-heading" className="text-2xl font-extrabold tracking-tight text-mainText-900">
          ...
          {testimonials.map((testimonial, index) => (
            <blockquote key={index} className="sm:flex lg:block">
              <svg
                ...
                aria-hidden="true"
                className="flex-shrink-0 text-mainText-300"
              >
                <path
              ...
              <div className="mt-8 sm:mt-0 sm:ml-6 lg:mt-10 lg:ml-0">
                <p className="text-lg text-mainText-600">{testimonial.quote}</p>
                <cite className="mt-4 block font-semibold not-italic text-mainText-900">{testimonial.attribution}</cite>
              </div>
            </blockquote>
          ))}
        </div>
