  ...
  return (
    <section id="reviews" aria-labelledby="reviews-heading" className="bg-background">
      <div className="max-w-2xl mx-auto py-24 px-4 sm:px-6 lg:max-w-7xl lg:py-32 lg:px-8 lg:grid lg:grid-cols-12 lg:gap-x-8">
          ...
          <div className="mt-10">
            ...
            {session ? (
              <Button
                ...
                className="mt-6 inline-flex w-full bg-formBackground border border-formText-300 rounded-md py-2 px-8 items-center justify-center text-sm font-medium text-formText-900 hover:bg-formText-50 sm:w-auto lg:w-full cursor-pointer"
              >
                Write a review
              </Button>
            ) : (
        ...
        {totalPages && (
          <div className="mt-12 flex items-center lg:col-start-6 lg:col-span-7 text-mainText-900">
            <div className="mr-2">
