import { RelatedProductsShopifyCollectionQueryResponse } from 'types/takeshape';

export const relatedProductsResponse: RelatedProductsShopifyCollectionQueryResponse = {
  collection: {
    products: {
      nodes: [
        {
