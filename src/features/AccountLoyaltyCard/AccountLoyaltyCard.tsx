...
export const AccountLoyaltyCard = ({ code, loyalty_card, assets }: AccountLoyaltyCardProps) => {
  return (
    <CardPanel primaryText="Deluxe ™️ Membership">
      ...
      <dl>
        <dt className="font-bold text-mainText-900 text-sm uppercase">Member Code</dt>
        <dd className="font-mono text-mainText-900 mb-1 tracking-widest">{code}</dd>
        <dt className="font-bold text-mainText-900 text-sm uppercase">Balance</dt>
        <dd className="font-mono text-mainText-900 mb-1 tracking-widest">{loyalty_card.balance} points</dd>
      </dl>
    </CardPanel>
  );
};
