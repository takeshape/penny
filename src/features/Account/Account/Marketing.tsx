...
interface AccountOverviewAccountMarketingForm {
  newsletters: Record<string, boolean>;
  acceptsMarketing: boolean;
}

export const AccountOverviewAccountMarketing = () => {
  ...
  } = useForm<AccountOverviewAccountMarketingForm>();
  ...
  const onSubmit = useCallback(
    async ({ acceptsMarketing, newsletters }: AccountOverviewAccountMarketingForm) => {
...
export default AccountOverviewAccountMarketing;
